...
@Service
public class ERC20TokenTransferService {
    ...
    public String TokenTransfer(String contractAddress, String ownerAddress, String toAddress, Integer amount ) throws IOException {
...
//        Address _from= new Address(ownerAddress);
        ...
        List<Type> inputParameters = Arrays.asList( _to, amount_uint);
